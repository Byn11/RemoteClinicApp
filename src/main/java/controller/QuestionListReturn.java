...
/**
 * Servlet implementation class QuestionListReturn
 */
@WebServlet("/QuestionListReturn")
public class QuestionListReturn extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionListReturn() {
        super();
