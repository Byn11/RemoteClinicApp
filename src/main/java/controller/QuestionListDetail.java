...
/**
 * Servlet implementation class QuestionListDetail
 */
@WebServlet("/QuestionListDetail")
public class QuestionListDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionListDetail() {
        super();
